...
<section class="relative mx-auto max-w-[85rem] px-4 pt-10 pb-24 sm:px-6 lg:px-8">
    {{-- Decorating SVG elements --}}
    <div class="absolute top-[55%] left-0 scale-90 md:top-[20%] xl:top-[25%] xl:left-[10%]">
        <svg
            width="64"
            height="64"
            fill="none"
    ...
    <div class="mx-auto mt-5 max-w-xl text-center">
        <h2 class="block text-4xl leading-tight font-bold tracking-tight text-balance text-neutral-800 md:text-5xl lg:text-6xl dark:text-neutral-200">
    ...
    <div class="mt-8 flex justify-center gap-3">
        <a
            href="{{ url('/contact') }}"
            id="hero-alt-cta"
            class="group inline-flex items-center justify-center gap-x-2 rounded-lg border border-transparent bg-yellow-500 px-6 py-3.5 text-sm font-bold text-neutral-900 ring-zinc-500 transition duration-300 hover:bg-yellow-400 focus-visible:ring-3 outline-hidden active:bg-yellow-500 2xl:text-base dark:ring-zinc-200 dark:focus:outline-hidden"
        >
            Get a Free Quote
